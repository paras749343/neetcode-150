...
import problems.arraysandhashing.ContainsDuplicateQ217;
import problems.arraysandhashing.EncodeAndDecodeStringsQ659;
import problems.arraysandhashing.GroupAnagramsQ49;
import problems.arraysandhashing.LongestConsecutiveSequenceQ128;
import problems.arraysandhashing.ProductOfArrayExceptSelfQ238;
import problems.arraysandhashing.TopKFrequentElementsQ347;
...
public class TestArraysAndHashing {
  ...
  public void testGroupAnagramsQ49() {
    ...
    var result = groupAnagramsQ49.groupAnagrams(
  ...
  public void testLongestConsecutiveSequenceQ128() {
    ...
    var result = longestConsecutiveSequenceQ128.longestConsecutive(
